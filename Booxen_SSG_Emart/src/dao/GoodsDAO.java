...
public class GoodsDAO {
	  ...
	  private SqlSessionFactory sqlSessionFactory = null;
	    ...
	    public  List  GetCategoryDispList(java.util.HashMap map)throws SQLException{
	    	List list = null;
	        
	        SqlSession session = sqlSessionFactory.openSession();
	 
	        try {
	        	list = session.selectList("Goods.GetCategoryDispList",map);
	        } finally {
	            session.close();
	        }
	    ...
	    public  List  GetOriginGoodsList(java.util.HashMap map)throws SQLException{
	    	List list = null;
	        
	        SqlSession session = sqlSessionFactory.openSession();
	 
	        try {
	        	list = session.selectList("Goods.GetOriginGoodsList",map);
	        } finally {
	            session.close();
	        }

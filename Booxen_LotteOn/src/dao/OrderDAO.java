...
public class OrderDAO {
	  private SqlSessionFactory sqlSessionFactory = null;
	   ...
	   public  List  GetTransNoList(java.util.HashMap map)throws SQLException{
	        ...
	        try {
	        	list = session.selectList("Goods.GetTransNoList");
	        } finally {
	            session.close();
	        }
	   ...
	   public  List  GetOrderDbList(java.util.HashMap map)throws SQLException{
	    	List list = null;
	        
	        SqlSession session = sqlSessionFactory.openSession();
	 
	        try {
	        	list = session.selectList("Goods.GetOrderDbList");
	        } finally {
	            session.close();
	        }
	   ...
	   public  List  GetGoodsPriceList(java.util.HashMap map)throws SQLException{
	    	List list = null;
	        
	        SqlSession session = sqlSessionFactory.openSession();
	 
	        try {
	        	list = session.selectList("Goods.GetGoodsPriceList", map);
	        } finally {
	            session.close();
	        }

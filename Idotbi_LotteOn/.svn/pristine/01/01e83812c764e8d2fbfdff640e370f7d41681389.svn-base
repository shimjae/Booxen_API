...
public class GoodsDAO {
	  ...
	  private SqlSessionFactory sqlSessionFactory = null;
	    ...
	    public  List  GetCategoryList(java.util.HashMap map)throws SQLException{
	    	List list = null;
	        
	        SqlSession session = sqlSessionFactory.openSession();
	 
	        try {
	        	list = session.selectList("Goods.GetCategoryList",map);
	        } finally {
	            session.close();
	        }
	    ...
	    public void DelItem(java.util.HashMap map){
	   	 
	        SqlSession session = sqlSessionFactory.openSession();
	 
	        try {
	            session.update("Goods.DelItem", map);
	        } finally {
	            session.commit();
	            session.close();
	        }
	    ...
	    public  List<Goods> GetGoodsInfo(java.util.HashMap map){
	        List<Goods> list = null;
	        SqlSession session = sqlSessionFactory.openSession();
	 
	        try {
	            list = session.selectList("Goods.GetGoodsInfo",map);
	        }catch (Exception e) {
				// TODO: handle exception
	        	e.printStackTrace();
			} 
